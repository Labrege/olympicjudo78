    ...
    <div class="rest">
      ...
      <div class="valeurs-container contenue_afficher">
          <div class="valeurs-texte">
            <h2> Judo</h2>
            <p> Sport pour tous les âges, pour toutes les morphologies, pour tous les caractères, des plus timides au plus extravertis, le judo représente une école de vie où l'éducation et le respect sont présents dans tous les enseignements.
</p>
          </div>
      </div>
      ...
      <div class="valeurs-container contenue_cacher">
          <div class="valeurs-texte">
            ...
            <p> Pratique combinée du judo sous tous ses aspects (techniques, randori, kata….) et de la musculation. 
Judo, Ju-Jitsu (self-défense) et Taïso (préparation du corps à l'effort)
